 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var B0=g,j0=Symbol.for("react.element"),R0=Symbol.for("react.fragment"),_0=Object.prototype.hasOwnProperty,H0=B0.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,U0={key:!0,ref:!0,__self:!0,__source:!0};function Js(e,n,t){var r,l={},o=null,i=null;t!==void 0&&(o=""+t),n.key!==void 0&&(o=""+n.key),n.ref!==void 0&&(i=n.ref);for(r in n)_0.call(n,r)&&!U0.hasOwnProperty(r)&&(l[r]=n[r]);if(e&&e.defaultProps)for(r in n=e.defaultProps,n)l[r]===void 0&&(l[r]=n[r]);return{$$typeof:j0,type:e,key:o,ref:i,props:l,_owner:H0.current}}kl.Fragment=R0;kl.jsx=Js;kl.jsxs=Js;Us.exports=kl;var u=Us.exports,yo={},Zs={exports:{}},Se={},qs={exports:{}},eu={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function n(P,N){var L=P.length;P.push(N);e:for(;0<L;){var W=L-1>>>1,J=P[W];if(0<l(J,N))P[W]=N,P[L]=J,L=W;else break e}}function t(P){return P.length===0?null:P[0]}function r(P){if(P.length===0)return null;var N=P[0],L=P.pop();if(L!==N){P[0]=L;e:for(var W=0,J=P.length,Ir=J>>>1;W<Ir;){var kn=2*(W+1)-1,Fl=P[kn],Cn=kn+1,yr=P[Cn];if(0>l(Fl,L))Cn<J&&0>l(yr,Fl)?(P[W]=yr,P[Cn]=L,W=Cn):(P[W]=Fl,P[kn]=L,W=kn);else if(Cn<J&&0>l(yr,L))P[W]=yr,P[Cn]=L,W=Cn;else break e}}return N}function l(P,N){var L=P.sortIndex-N.sortIndex;return L!==0?L:P.id-N.id}if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;e.unstable_now=function(){return o.now()}}else{var i=Date,a=i.now();e.unstable_now=function(){return i.now()-a}}var s=[],c=[],h=1,m=null,A=3,v=!1,S=!1,y=!1,w=typeof setTimeout=="function"?setTimeout:null,d=typeof clearTimeout=="function"?clearTimeout:null,f=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function p(P){for(var N=t(c);N!==null;){if(N.callback===null)r(c);else if(N.startTime<=P)r(c),N.sortIndex=N.expirationTime,n(s,N);else break;N=t(c)}}function I(P){if(y=!1,p(P),!S)if(t(s)!==null)S=!0,Kl(k);else{var N=t(c);N!==null&&zl(I,N.startTime-P)}}function k(P,N){S=!1,y&&(y=!1,d(M),M=-1),v=!0;var L=A;try{for(p(N),m=t(s);m!==null&&(!(m.expirationTime>N)||P&&!Ne());){var W=m.callback;if(typeof W=="function"){m.callback=null,A=m.priorityLevel;var J=W(m.expirationTime<=N);N=e.unstable_now(),typeof J=="function"?m.callback=J:m===t(s)&&r(s),p(N)}else r(s);m=t(s)}if(m!==null)var Ir=!0;else{var kn=t(c);kn!==null&&zl(I,kn.startTime-N),Ir=!1}return Ir}finally{m=null,A=L,v=!1}}var T=!1,E=null,M=-1,V=5,G=-1;function Ne(){return!(e.unstable_now()-G<V)}function St(){if(E!==null){var P=e.unstable_now();G=P;var N=!0;try{N=E(!0,P)}finally{N?xt():(T=!1,E=null)}}else T=!1}var xt;if(typeof f=="function")xt=function(){f(St)};else if(typeof MessageChannel<"u"){var ga=new MessageChannel,A0=ga.port2;ga.port1.onmessage=St,xt=function(){A0.postMessage(null)}}else xt=function(){w(St,0)};function Kl(P){E=P,T||(T=!0,xt())}function zl(P,N){M=w(function(){P(e.unstable_now())},N)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(P){P.callback=null},e.unstable_continueExecution=function(){S||v||(S=!0,Kl(k))},e.unstable_forceFrameRate=function(P){0>P||125<P?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):V=0<P?Math.floor(1e3/P):5},e.unstable_getCurrentPriorityLevel=function(){return A},e.unstable_getFirstCallbackNode=function(){return t(s)},e.unstable_next=function(P){switch(A){case 1:case 2:case 3:var N=3;break;default:N=A}var L=A;A=N;try{return P()}finally{A=L}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(P,N){switch(P){case 1:case 2:case 3:case 4:case 5:break;default:P=3}var L=A;A=P;try{return N()}finally{A=L}},e.unstable_scheduleCallback=function(P,N,L){var W=e.unstable_now();switch(typeof L=="object"&&L!==null?(L=L.delay,L=typeof L=="number"&&0<L?W+L:W):L=W,P){case 1:var J=-1;break;case 2:J=250;break;case 5:J=1073741823;break;case 4:J=1e4;break;default:J=5e3}return J=L+J,P={id:h++,callback:N,priorityLevel:P,startTime:L,expirationTime:J,sortIndex:-1},L>W?(P.sortIndex=L,n(c,P),t(s)===null&&P===t(c)&&(y?(d(M),M=-1):y=!0,zl(I,L-W))):(P.sortIndex=J,n(s,P),S||v||(S=!0,Kl(k))),P},e.unstable_shouldYield=Ne,e.unstable_wrapCallback=function(P){var N=A;return function(){var L=A;A=N;try{return P.apply(this,arguments)}finally{A=L}}}})(eu);qs.exports=eu;var K0=qs.exports;/**
 * @license React
 ...
 *
 * @license MIT
 */function ur(){return ur=Object.assign?Object.assign.bind():function(e){for(var n=1;n<arguments.length;n++){var t=arguments[n];for(var r in t)Object.prototype.hasOwnProperty.call(t,r)&&(e[r]=t[r])}return e},ur.apply(this,arguments)}const Aa=g.createContext(null),vp=g.createContext(null),wn=g.createContext(null),Ul=g.createContext(null),qe=g.createContext({outlet:null,matches:[],isDataRoute:!1}),t0=g.createContext(null);function Sp(e,n){let{relative:t}=n===void 0?{}:n;yt()||Q(!1);let{basename:r,navigator:l}=g.useContext(wn),{hash:o,pathname:i,search:a}=o0(e,{relative:t}),s=i;return r!=="/"&&(s=i==="/"?r:gn([r,i])),l.createHref({pathname:s,search:a,hash:o})}function yt(){return g.useContext(Ul)!=null}function Ar(){return yt()||Q(!1),g.useContext(Ul).location}function r0(e){g.useContext(wn).static||g.useLayoutEffect(e)}function gr(){let{isDataRoute:e}=g.useContext(qe);return e?Dp():xp()}function xp(){yt()||Q(!1);let e=g.useContext(Aa),{basename:n,future:t,navigator:r}=g.useContext(wn),{matches:l}=g.useContext(qe),{pathname:o}=Ar(),i=JSON.stringify(ma(l,t.v7_relativeSplatPath)),a=g.useRef(!1);return r0(()=>{a.current=!0}),g.useCallback(function(c,h){if(h===void 0&&(h={}),!a.current)return;if(typeof c=="number"){r.go(c);return}let m=ha(c,JSON.parse(i),o,h.relative==="path");e==null&&n!=="/"&&(m.pathname=m.pathname==="/"?n:gn([n,m.pathname])),(h.replace?r.replace:r.push)(m,h.state,h)},[n,r,i,o,e])}function l0(){let{matches:e}=g.useContext(qe),n=e[e.length-1];return n?n.params:{}}function o0(e,n){let{relative:t}=n===void 0?{}:n,{future:r}=g.useContext(wn),{matches:l}=g.useContext(qe),{pathname:o}=Ar(),i=JSON.stringify(ma(l,r.v7_relativeSplatPath));return g.useMemo(()=>ha(e,JSON.parse(i),o,t==="path"),[e,i,o,t])}function wp(e,n){return kp(e,n)}function kp(e,n,t,r){yt()||Q(!1);let{navigator:l}=g.useContext(wn),{matches:o}=g.useContext(qe),i=o[o.length-1],a=i?i.params:{};i&&i.pathname;let s=i?i.pathnameBase:"/";i&&i.route;let c=Ar(),h;if(n){var m;let w=typeof n=="string"?It(n):n;s==="/"||(m=w.pathname)!=null&&m.startsWith(s)||Q(!1),h=w}else h=c;let A=h.pathname||"/",v=A;if(s!=="/"){let w=s.replace(/^\//,"").split("/");v="/"+A.replace(/^\//,"").split("/").slice(w.length).join("/")}let S=Yf(e,{pathname:v}),y=Mp(S&&S.map(w=>Object.assign({},w,{params:Object.assign({},a,w.params),pathname:gn([s,l.encodeLocation?l.encodeLocation(w.pathname).pathname:w.pathname]),pathnameBase:w.pathnameBase==="/"?s:gn([s,l.encodeLocation?l.encodeLocation(w.pathnameBase).pathname:w.pathnameBase])})),o,t,r);return n&&y?g.createElement(Ul.Provider,{value:{location:ur({pathname:"/",search:"",hash:"",state:null,key:"default"},h),navigationType:sn.Pop}},y):y}function Cp(){let e=Gp(),n=Ip(e)?e.status+" "+e.statusText:e instanceof Error?e.message:JSON.stringify(e),t=e instanceof Error?e.stack:null,l={padding:"0.5rem",backgroundColor:"rgba(200,200,200, 0.5)"};return g.createElement(g.Fragment,null,g.createElement("h2",null,"Unexpected Application Error!"),g.createElement("h3",{style:{fontStyle:"italic"}},n),t?g.createElement("pre",{style:l},t):null,null)}const Pp=g.createElement(Cp,null);class Tp extends g.Component{constructor(n){super(n),this.state={location:n.location,revalidation:n.revalidation,error:n.error}}static getDerivedStateFromError(n){return{error:n}}static getDerivedStateFromProps(n,t){return t.location!==n.location||t.revalidation!=="idle"&&n.revalidation==="idle"?{error:n.error,location:n.location,revalidation:n.revalidation}:{error:n.error!==void 0?n.error:t.error,location:t.location,revalidation:n.revalidation||t.revalidation}}componentDidCatch(n,t){console.error("React Router caught the following error during render",n,t)}render(){return this.state.error!==void 0?g.createElement(qe.Provider,{value:this.props.routeContext},g.createElement(t0.Provider,{value:this.state.error,children:this.props.component})):this.props.children}}function Ep(e){let{routeContext:n,match:t,children:r}=e,l=g.useContext(Aa);return l&&l.static&&l.staticContext&&(t.route.errorElement||t.route.ErrorBoundary)&&(l.staticContext._deepestRenderedBoundaryId=t.route.id),g.createElement(qe.Provider,{value:n},r)}function Mp(e,n,t,r){var l;if(n===void 0&&(n=[]),t===void 0&&(t=null),r===void 0&&(r=null),e==null){var o;if(!t)return null;if(t.errors)e=t.matches;else if((o=r)!=null&&o.v7_partialHydration&&n.length===0&&!t.initialized&&t.matches.length>0)e=t.matches;else return null}let i=e,a=(l=t)==null?void 0:l.errors;if(a!=null){let h=i.findIndex(m=>m.route.id&&(a==null?void 0:a[m.route.id])!==void 0);h>=0||Q(!1),i=i.slice(0,Math.min(i.length,h+1))}let s=!1,c=-1;if(t&&r&&r.v7_partialHydration)for(let h=0;h<i.length;h++){let m=i[h];if((m.route.HydrateFallback||m.route.hydrateFallbackElement)&&(c=h),m.route.id){let{loaderData:A,errors:v}=t,S=m.route.loader&&A[m.route.id]===void 0&&(!v||v[m.route.id]===void 0);if(m.route.lazy||S){s=!0,c>=0?i=i.slice(0,c+1):i=[i[0]];break}}}return i.reduceRight((h,m,A)=>{let v,S=!1,y=null,w=null;t&&(v=a&&m.route.id?a[m.route.id]:void 0,y=m.route.errorElement||Pp,s&&(c<0&&A===0?(Bp("route-fallback"),S=!0,w=null):c===A&&(S=!0,w=m.route.hydrateFallbackElement||null)));let d=n.concat(i.slice(0,A+1)),f=()=>{let p;return v?p=y:S?p=w:m.route.Component?p=g.createElement(m.route.Component,null):m.route.element?p=m.route.element:p=h,g.createElement(Ep,{match:m,routeContext:{outlet:h,matches:d,isDataRoute:t!=null},children:p})};return t&&(m.route.ErrorBoundary||m.route.errorElement||A===0)?g.createElement(Tp,{location:t.location,revalidation:t.revalidation,component:y,error:v,children:f(),routeContext:{outlet:null,matches:d,isDataRoute:!0}}):f()},null)}var i0=function(e){return e.UseBlocker="useBlocker",e.UseRevalidator="useRevalidator",e.UseNavigateStable="useNavigate",e}(i0||{}),a0=function(e){return e.UseBlocker="useBlocker",e.UseLoaderData="useLoaderData",e.UseActionData="useActionData",e.UseRouteError="useRouteError",e.UseNavigation="useNavigation",e.UseRouteLoaderData="useRouteLoaderData",e.UseMatches="useMatches",e.UseRevalidator="useRevalidator",e.UseNavigateStable="useNavigate",e.UseRouteId="useRouteId",e}(a0||{});function Np(e){let n=g.useContext(Aa);return n||Q(!1),n}function Lp(e){let n=g.useContext(vp);return n||Q(!1),n}function Op(e){let n=g.useContext(qe);return n||Q(!1),n}function s0(e){let n=Op(),t=n.matches[n.matches.length-1];return t.route.id||Q(!1),t.route.id}function Gp(){var e;let n=g.useContext(t0),t=Lp(),r=s0();return n!==void 0?n:(e=t.errors)==null?void 0:e[r]}function Dp(){let{router:e}=Np(i0.UseNavigateStable),n=s0(a0.UseNavigateStable),t=g.useRef(!1);return r0(()=>{t.current=!0}),g.useCallback(function(l,o){o===void 0&&(o={}),t.current&&(typeof l=="number"?e.navigate(l):e.navigate(l,ur({fromRouteId:n},o)))},[e,n])}const Os={};function Bp(e,n,t){Os[e]||(Os[e]=!0)}function jp(e,n){e==null||e.v7_startTransition,e==null||e.v7_relativeSplatPath}function Rp(e){let{to:n,replace:t,state:r,relative:l}=e;yt()||Q(!1);let{future:o,static:i}=g.useContext(wn),{matches:a}=g.useContext(qe),{pathname:s}=Ar(),c=gr(),h=ha(n,ma(a,o.v7_relativeSplatPath),s,l==="path"),m=JSON.stringify(h);return g.useEffect(()=>c(JSON.parse(m),{replace:t,state:r,relative:l}),[c,m,l,t,r]),null}function zn(e){Q(!1)}function _p(e){let{basename:n="/",children:t=null,location:r,navigationType:l=sn.Pop,navigator:o,static:i=!1,future:a}=e;yt()&&Q(!1);let s=n.replace(/^\/*/,"/"),c=g.useMemo(()=>({basename:s,navigator:o,static:i,future:ur({v7_relativeSplatPath:!1},a)}),[s,a,o,i]);typeof r=="string"&&(r=It(r));let{pathname:h="/",search:m="",hash:A="",state:v=null,key:S="default"}=r,y=g.useMemo(()=>{let w=pa(h,s);return w==null?null:{location:{pathname:w,search:m,hash:A,state:v,key:S},navigationType:l}},[s,h,m,A,v,S,l]);return y==null?null:g.createElement(wn.Provider,{value:c},g.createElement(Ul.Provider,{children:t,value:y}))}function Hp(e){let{children:n,location:t}=e;return wp(pi(n),t)}new Promise(()=>{});function pi(e,n){n===void 0&&(n=[]);let t=[];return g.Children.forEach(e,(r,l)=>{if(!g.isValidElement(r))return;let o=[...n,l];if(r.type===g.Fragment){t.push.apply(t,pi(r.props.children,o));return}r.type!==zn&&Q(!1),!r.props.index||!r.props.children||Q(!1);let i={id:r.props.id||o.join("-"),caseSensitive:r.props.caseSensitive,element:r.props.element,Component:r.props.Component,index:r.props.index,path:r.props.path,loader:r.props.loader,action:r.props.action,errorElement:r.props.errorElement,ErrorBoundary:r.props.ErrorBoundary,hasErrorBoundary:r.props.ErrorBoundary!=null||r.props.errorElement!=null,shouldRevalidate:r.props.shouldRevalidate,handle:r.props.handle,lazy:r.props.lazy};r.props.children&&(i.children=pi(r.props.children,o)),t.push(i)}),t}/**
 ...
 *
 * @license MIT
 */function mi(){return mi=Object.assign?Object.assign.bind():function(e){for(var n=1;n<arguments.length;n++){var t=arguments[n];for(var r in t)Object.prototype.hasOwnProperty.call(t,r)&&(e[r]=t[r])}return e},mi.apply(this,arguments)}function Up(e,n){if(e==null)return{};var t={},r=Object.keys(e),l,o;for(o=0;o<r.length;o++)l=r[o],!(n.indexOf(l)>=0)&&(t[l]=e[l]);return t}function Kp(e){return!!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)}function zp(e,n){return e.button===0&&(!n||n==="_self")&&!Kp(e)}const Fp=["onClick","relative","reloadDocument","replace","state","target","to","preventScrollReset","viewTransition"],Vp="6";try{window.__reactRouterVersion=Vp}catch{}const Wp="startTransition",Gs=D0[Wp];function $p(e){let{basename:n,children:t,future:r,window:l}=e,o=g.useRef();o.current==null&&(o.current=Qf({window:l,v5Compat:!0}));let i=o.current,[a,s]=g.useState({action:i.action,location:i.location}),{v7_startTransition:c}=r||{},h=g.useCallback(m=>{c&&Gs?Gs(()=>s(m)):s(m)},[s,c]);return g.useLayoutEffect(()=>i.listen(h),[i,h]),g.useEffect(()=>jp(r),[r]),g.createElement(_p,{basename:n,children:t,location:a.location,navigationType:a.action,navigator:i,future:r})}const Qp=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u",Xp=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,_n=g.forwardRef(function(n,t){let{onClick:r,relative:l,reloadDocument:o,replace:i,state:a,target:s,to:c,preventScrollReset:h,viewTransition:m}=n,A=Up(n,Fp),{basename:v}=g.useContext(wn),S,y=!1;if(typeof c=="string"&&Xp.test(c)&&(S=c,Qp))try{let p=new URL(window.location.href),I=c.startsWith("//")?new URL(p.protocol+c):new URL(c),k=pa(I.pathname,v);I.origin===p.origin&&k!=null?c=k+I.search+I.hash:y=!0}catch{}let w=Sp(c,{relative:l}),d=bp(c,{replace:i,state:a,target:s,preventScrollReset:h,relative:l,viewTransition:m});function f(p){r&&r(p),p.defaultPrevented||d(p)}return g.createElement("a",mi({},A,{href:S||w,onClick:y||o?r:f,ref:t,target:s}))});var Ds;(function(e){e.UseScrollRestoration="useScrollRestoration",e.UseSubmit="useSubmit",e.UseSubmitFetcher="useSubmitFetcher",e.UseFetcher="useFetcher",e.useViewTransitionState="useViewTransitionState"})(Ds||(Ds={}));var Bs;(function(e){e.UseFetcher="useFetcher",e.UseFetchers="useFetchers",e.UseScrollRestoration="useScrollRestoration"})(Bs||(Bs={}));function bp(e,n){let{target:t,replace:r,state:l,preventScrollReset:o,relative:i,viewTransition:a}=n===void 0?{}:n,s=gr(),c=Ar(),h=o0(e,{relative:i});return g.useCallback(m=>{if(zp(m,t)){m.preventDefault();let A=r!==void 0?r:vl(c)===vl(h);s(e,{replace:A,state:l,preventScrollReset:o,relative:i,viewTransition:a})}},[c,s,h,r,l,t,e,o,i,a])}const Yp=[{id:"20260505084401",title:"美 펜타곤, 8개 빅테크와 기밀망 AI 계약...Anthropic만 '공급망 리스크' 배제",summary:"미 국방부가 5월 1~4일 OpenAI·Google·Microsoft·AWS·Nvidia·SpaceX·Reflection·Oracle 8개사와 IL6·IL7 기밀 네트워크용 AI 배치 계약을 잇따라 체결했다. Anthropic은 '자율 살상무기·대규모 감시 사용 동의' 거부로 공식 공급망 리스크 라벨이 붙어 배제됐다. 5년 누적 약 200억 달러 규모로, 한미 동맹 차원의 한국 국방 AI 도입 정책에도 직접 영향이 예상된다.",category:"정책",author:"Prompt Daily 편집팀",date:"2026-05-05T08:45:00+09:00",readTime:"6분",image:"https://images.unsplash.com/photo-1529107386315-e1a2ed48a620?w=800",breaking:!0,content:`## 8개사 'Impact Level 6·7' 진입, Anthropic은 블랙리스트
