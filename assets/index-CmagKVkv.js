 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(n){function e(E,w){var k=E.length;E.push(w);n:for(;0<k;){var z=k-1>>>1,J=E[z];if(0<o(J,w))E[z]=w,E[k]=J,k=z;else break n}}function t(E){return E.length===0?null:E[0]}function r(E){if(E.length===0)return null;var w=E[0],k=E.pop();if(k!==w){E[0]=k;n:for(var z=0,J=E.length,gr=J>>>1;z<gr;){var Me=2*(z+1)-1,$o=E[Me],Te=Me+1,yr=E[Te];if(0>o($o,k))Te<J&&0>o(yr,$o)?(E[z]=yr,E[Te]=k,z=Te):(E[z]=$o,E[Me]=k,z=Me);else if(Te<J&&0>o(yr,k))E[z]=yr,E[Te]=k,z=Te;else break n}}return w}function o(E,w){var k=E.sortIndex-w.sortIndex;return k!==0?k:E.id-w.id}if(typeof performance=="object"&&typeof performance.now=="function"){var l=performance;n.unstable_now=function(){return l.now()}}else{var i=Date,a=i.now();n.unstable_now=function(){return i.now()-a}}var s=[],c=[],m=1,A=null,I=3,S=!1,v=!1,y=!1,P=typeof setTimeout=="function"?setTimeout:null,d=typeof clearTimeout=="function"?clearTimeout:null,p=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function f(E){for(var w=t(c);w!==null;){if(w.callback===null)r(c);else if(w.startTime<=E)r(c),w.sortIndex=w.expirationTime,e(s,w);else break;w=t(c)}}function g(E){if(y=!1,f(E),!v)if(t(s)!==null)v=!0,_o(M);else{var w=t(c);w!==null&&Fo(g,w.startTime-E)}}function M(E,w){v=!1,y&&(y=!1,d(G),G=-1),S=!0;var k=I;try{for(f(w),A=t(s);A!==null&&(!(A.expirationTime>w)||E&&!kn());){var z=A.callback;if(typeof z=="function"){A.callback=null,I=A.priorityLevel;var J=z(A.expirationTime<=w);w=n.unstable_now(),typeof J=="function"?A.callback=J:A===t(s)&&r(s),f(w)}else r(s);A=t(s)}if(A!==null)var gr=!0;else{var Me=t(c);Me!==null&&Fo(g,Me.startTime-w),gr=!1}return gr}finally{A=null,I=k,S=!1}}var x=!1,L=null,G=-1,$=5,N=-1;function kn(){return!(n.unstable_now()-N<$)}function vt(){if(L!==null){var E=n.unstable_now();N=E;var w=!0;try{w=L(!0,E)}finally{w?Ct():(x=!1,L=null)}}else x=!1}var Ct;if(typeof p=="function")Ct=function(){p(vt)};else if(typeof MessageChannel<"u"){var ha=new MessageChannel,Ic=ha.port2;ha.port1.onmessage=vt,Ct=function(){Ic.postMessage(null)}}else Ct=function(){P(vt,0)};function _o(E){L=E,x||(x=!0,Ct())}function Fo(E,w){G=P(function(){E(n.unstable_now())},w)}n.unstable_IdlePriority=5,n.unstable_ImmediatePriority=1,n.unstable_LowPriority=4,n.unstable_NormalPriority=3,n.unstable_Profiling=null,n.unstable_UserBlockingPriority=2,n.unstable_cancelCallback=function(E){E.callback=null},n.unstable_continueExecution=function(){v||S||(v=!0,_o(M))},n.unstable_forceFrameRate=function(E){0>E||125<E?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):$=0<E?Math.floor(1e3/E):5},n.unstable_getCurrentPriorityLevel=function(){return I},n.unstable_getFirstCallbackNode=function(){return t(s)},n.unstable_next=function(E){switch(I){case 1:case 2:case 3:var w=3;break;default:w=I}var k=I;I=w;try{return E()}finally{I=k}},n.unstable_pauseExecution=function(){},n.unstable_requestPaint=function(){},n.unstable_runWithPriority=function(E,w){switch(E){case 1:case 2:case 3:case 4:case 5:break;default:E=3}var k=I;I=E;try{return w()}finally{I=k}},n.unstable_scheduleCallback=function(E,w,k){var z=n.unstable_now();switch(typeof k=="object"&&k!==null?(k=k.delay,k=typeof k=="number"&&0<k?z+k:z):k=z,E){case 1:var J=-1;break;case 2:J=250;break;case 5:J=1073741823;break;case 4:J=1e4;break;default:J=5e3}return J=k+J,E={id:m++,callback:w,priorityLevel:E,startTime:k,expirationTime:J,sortIndex:-1},k>z?(E.sortIndex=k,e(c,E),t(s)===null&&E===t(c)&&(y?(d(G),G=-1):y=!0,Fo(g,k-z))):(E.sortIndex=J,e(s,E),v||S||(v=!0,_o(M))),E},n.unstable_shouldYield=kn,n.unstable_wrapCallback=function(E){var w=I;return function(){var k=I;I=w;try{return E.apply(this,arguments)}finally{I=k}}}})(nu);qs.exports=nu;var Vc=qs.exports;/**
 * @license React
 ...
 *
 * @license MIT
 */function Ai(){return Ai=Object.assign?Object.assign.bind():function(n){for(var e=1;e<arguments.length;e++){var t=arguments[e];for(var r in t)Object.prototype.hasOwnProperty.call(t,r)&&(n[r]=t[r])}return n},Ai.apply(this,arguments)}function U2(n,e){if(n==null)return{};var t={},r=Object.keys(n),o,l;for(l=0;l<r.length;l++)o=r[l],!(e.indexOf(o)>=0)&&(t[o]=n[o]);return t}function j2(n){return!!(n.metaKey||n.altKey||n.ctrlKey||n.shiftKey)}function V2(n,e){return n.button===0&&(!e||e==="_self")&&!j2(n)}const _2=["onClick","relative","reloadDocument","replace","state","target","to","preventScrollReset","viewTransition"],F2="6";try{window.__reactRouterVersion=F2}catch{}const $2="startTransition",Ns=Dc[$2];function z2(n){let{basename:e,children:t,future:r,window:o}=n,l=h.useRef();l.current==null&&(l.current=Wp({window:o,v5Compat:!0}));let i=l.current,[a,s]=h.useState({action:i.action,location:i.location}),{v7_startTransition:c}=r||{},m=h.useCallback(A=>{c&&Ns?Ns(()=>s(A)):s(A)},[s,c]);return h.useLayoutEffect(()=>i.listen(m),[i,m]),h.useEffect(()=>B2(r),[r]),h.createElement(K2,{basename:e,children:t,location:a.location,navigationType:a.action,navigator:i,future:r})}const W2=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u",X2=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,He=h.forwardRef(function(e,t){let{onClick:r,relative:o,reloadDocument:l,replace:i,state:a,target:s,to:c,preventScrollReset:m,viewTransition:A}=e,I=U2(e,_2),{basename:S}=h.useContext(Pe),v,y=!1;if(typeof c=="string"&&X2.test(c)&&(v=c,W2))try{let f=new URL(window.location.href),g=c.startsWith("//")?new URL(f.protocol+c):new URL(c),M=fa(g.pathname,S);g.origin===f.origin&&M!=null?c=M+g.search+g.hash:y=!0}catch{}let P=S2(c,{relative:o}),d=b2(c,{replace:i,state:a,target:s,preventScrollReset:m,relative:o,viewTransition:A});function p(f){r&&r(f),f.defaultPrevented||d(f)}return h.createElement("a",Ai({},I,{href:v||P,onClick:y||l?r:p,ref:t,target:s}))});var Ds;(function(n){n.UseScrollRestoration="useScrollRestoration",n.UseSubmit="useSubmit",n.UseSubmitFetcher="useSubmitFetcher",n.UseFetcher="useFetcher",n.useViewTransitionState="useViewTransitionState"})(Ds||(Ds={}));var Bs;(function(n){n.UseFetcher="useFetcher",n.UseFetchers="useFetchers",n.UseScrollRestoration="useScrollRestoration"})(Bs||(Bs={}));function b2(n,e){let{target:t,replace:r,state:o,preventScrollReset:l,relative:i,viewTransition:a}=e===void 0?{}:e,s=hr(),c=Ir(),m=lc(n,{relative:i});return h.useCallback(A=>{if(V2(A,t)){A.preventDefault();let I=r!==void 0?r:vo(c)===vo(m);s(n,{replace:I,state:o,preventScrollReset:l,relative:i,viewTransition:a})}},[c,s,m,r,o,t,n,l,i,a])}const Q2=[{id:"20260520180001",title:"삼성전자, 차세대 '갤럭시 링' AI 기능 대폭 강화",summary:"삼성전자가 2026년 출시 예정인 갤럭시 링에 강력한 AI 기반 건강 관리 기능을 탑재할 것으로 알려졌다. 개인 맞춤형 건강 분석 및 예측 기능이 강화될 전망이다.",category:"테크",author:"Prompt Daily 편집팀",date:"2026-05-20T18:00:00+09:00",readTime:"3분",image:"https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?w=800",breaking:!1,content:`## 삼성전자, 차세대 '갤럭시 링' AI 기능 대폭 강화
