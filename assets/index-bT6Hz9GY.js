 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var B0=g,R0=Symbol.for("react.element"),j0=Symbol.for("react.fragment"),_0=Object.prototype.hasOwnProperty,H0=B0.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,K0={key:!0,ref:!0,__self:!0,__source:!0};function Js(e,n,t){var r,l={},o=null,i=null;t!==void 0&&(o=""+t),n.key!==void 0&&(o=""+n.key),n.ref!==void 0&&(i=n.ref);for(r in n)_0.call(n,r)&&!K0.hasOwnProperty(r)&&(l[r]=n[r]);if(e&&e.defaultProps)for(r in n=e.defaultProps,n)l[r]===void 0&&(l[r]=n[r]);return{$$typeof:R0,type:e,key:o,ref:i,props:l,_owner:H0.current}}kl.Fragment=j0;kl.jsx=Js;kl.jsxs=Js;Ks.exports=kl;var u=Ks.exports,yo={},Zs={exports:{}},Se={},qs={exports:{}},eu={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function n(C,L){var N=C.length;C.push(L);e:for(;0<N;){var W=N-1>>>1,J=C[W];if(0<l(J,L))C[W]=L,C[N]=J,N=W;else break e}}function t(C){return C.length===0?null:C[0]}function r(C){if(C.length===0)return null;var L=C[0],N=C.pop();if(N!==L){C[0]=N;e:for(var W=0,J=C.length,Ir=J>>>1;W<Ir;){var kn=2*(W+1)-1,Vl=C[kn],Pn=kn+1,yr=C[Pn];if(0>l(Vl,N))Pn<J&&0>l(yr,Vl)?(C[W]=yr,C[Pn]=N,W=Pn):(C[W]=Vl,C[kn]=N,W=kn);else if(Pn<J&&0>l(yr,N))C[W]=yr,C[Pn]=N,W=Pn;else break e}}return L}function l(C,L){var N=C.sortIndex-L.sortIndex;return N!==0?N:C.id-L.id}if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;e.unstable_now=function(){return o.now()}}else{var i=Date,a=i.now();e.unstable_now=function(){return i.now()-a}}var s=[],c=[],h=1,m=null,A=3,v=!1,S=!1,y=!1,w=typeof setTimeout=="function"?setTimeout:null,d=typeof clearTimeout=="function"?clearTimeout:null,f=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function p(C){for(var L=t(c);L!==null;){if(L.callback===null)r(c);else if(L.startTime<=C)r(c),L.sortIndex=L.expirationTime,n(s,L);else break;L=t(c)}}function I(C){if(y=!1,p(C),!S)if(t(s)!==null)S=!0,Ul(k);else{var L=t(c);L!==null&&zl(I,L.startTime-C)}}function k(C,L){S=!1,y&&(y=!1,d(M),M=-1),v=!0;var N=A;try{for(p(L),m=t(s);m!==null&&(!(m.expirationTime>L)||C&&!Le());){var W=m.callback;if(typeof W=="function"){m.callback=null,A=m.priorityLevel;var J=W(m.expirationTime<=L);L=e.unstable_now(),typeof J=="function"?m.callback=J:m===t(s)&&r(s),p(L)}else r(s);m=t(s)}if(m!==null)var Ir=!0;else{var kn=t(c);kn!==null&&zl(I,kn.startTime-L),Ir=!1}return Ir}finally{m=null,A=N,v=!1}}var E=!1,T=null,M=-1,F=5,G=-1;function Le(){return!(e.unstable_now()-G<F)}function St(){if(T!==null){var C=e.unstable_now();G=C;var L=!0;try{L=T(!0,C)}finally{L?xt():(E=!1,T=null)}}else E=!1}var xt;if(typeof f=="function")xt=function(){f(St)};else if(typeof MessageChannel<"u"){var ga=new MessageChannel,A0=ga.port2;ga.port1.onmessage=St,xt=function(){A0.postMessage(null)}}else xt=function(){w(St,0)};function Ul(C){T=C,E||(E=!0,xt())}function zl(C,L){M=w(function(){C(e.unstable_now())},L)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(C){C.callback=null},e.unstable_continueExecution=function(){S||v||(S=!0,Ul(k))},e.unstable_forceFrameRate=function(C){0>C||125<C?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):F=0<C?Math.floor(1e3/C):5},e.unstable_getCurrentPriorityLevel=function(){return A},e.unstable_getFirstCallbackNode=function(){return t(s)},e.unstable_next=function(C){switch(A){case 1:case 2:case 3:var L=3;break;default:L=A}var N=A;A=L;try{return C()}finally{A=N}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(C,L){switch(C){case 1:case 2:case 3:case 4:case 5:break;default:C=3}var N=A;A=C;try{return L()}finally{A=N}},e.unstable_scheduleCallback=function(C,L,N){var W=e.unstable_now();switch(typeof N=="object"&&N!==null?(N=N.delay,N=typeof N=="number"&&0<N?W+N:W):N=W,C){case 1:var J=-1;break;case 2:J=250;break;case 5:J=1073741823;break;case 4:J=1e4;break;default:J=5e3}return J=N+J,C={id:h++,callback:L,priorityLevel:C,startTime:N,expirationTime:J,sortIndex:-1},N>W?(C.sortIndex=N,n(c,C),t(s)===null&&C===t(c)&&(y?(d(M),M=-1):y=!0,zl(I,N-W))):(C.sortIndex=J,n(s,C),S||v||(S=!0,Ul(k))),C},e.unstable_shouldYield=Le,e.unstable_wrapCallback=function(C){var L=A;return function(){var N=A;A=L;try{return C.apply(this,arguments)}finally{A=N}}}})(eu);qs.exports=eu;var U0=qs.exports;/**
 * @license React
 ...
 *
 * @license MIT
 */function mi(){return mi=Object.assign?Object.assign.bind():function(e){for(var n=1;n<arguments.length;n++){var t=arguments[n];for(var r in t)Object.prototype.hasOwnProperty.call(t,r)&&(e[r]=t[r])}return e},mi.apply(this,arguments)}function Kp(e,n){if(e==null)return{};var t={},r=Object.keys(e),l,o;for(o=0;o<r.length;o++)l=r[o],!(n.indexOf(l)>=0)&&(t[l]=e[l]);return t}function Up(e){return!!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)}function zp(e,n){return e.button===0&&(!n||n==="_self")&&!Up(e)}const Vp=["onClick","relative","reloadDocument","replace","state","target","to","preventScrollReset","viewTransition"],Fp="6";try{window.__reactRouterVersion=Fp}catch{}const Wp="startTransition",Gs=D0[Wp];function $p(e){let{basename:n,children:t,future:r,window:l}=e,o=g.useRef();o.current==null&&(o.current=Xf({window:l,v5Compat:!0}));let i=o.current,[a,s]=g.useState({action:i.action,location:i.location}),{v7_startTransition:c}=r||{},h=g.useCallback(m=>{c&&Gs?Gs(()=>s(m)):s(m)},[s,c]);return g.useLayoutEffect(()=>i.listen(h),[i,h]),g.useEffect(()=>Rp(r),[r]),g.createElement(_p,{basename:n,children:t,location:a.location,navigationType:a.action,navigator:i,future:r})}const Xp=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u",Qp=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,_n=g.forwardRef(function(n,t){let{onClick:r,relative:l,reloadDocument:o,replace:i,state:a,target:s,to:c,preventScrollReset:h,viewTransition:m}=n,A=Kp(n,Vp),{basename:v}=g.useContext(wn),S,y=!1;if(typeof c=="string"&&Qp.test(c)&&(S=c,Xp))try{let p=new URL(window.location.href),I=c.startsWith("//")?new URL(p.protocol+c):new URL(c),k=pa(I.pathname,v);I.origin===p.origin&&k!=null?c=k+I.search+I.hash:y=!0}catch{}let w=Sp(c,{relative:l}),d=Yp(c,{replace:i,state:a,target:s,preventScrollReset:h,relative:l,viewTransition:m});function f(p){r&&r(p),p.defaultPrevented||d(p)}return g.createElement("a",mi({},A,{href:S||w,onClick:y||o?r:f,ref:t,target:s}))});var Ds;(function(e){e.UseScrollRestoration="useScrollRestoration",e.UseSubmit="useSubmit",e.UseSubmitFetcher="useSubmitFetcher",e.UseFetcher="useFetcher",e.useViewTransitionState="useViewTransitionState"})(Ds||(Ds={}));var Bs;(function(e){e.UseFetcher="useFetcher",e.UseFetchers="useFetchers",e.UseScrollRestoration="useScrollRestoration"})(Bs||(Bs={}));function Yp(e,n){let{target:t,replace:r,state:l,preventScrollReset:o,relative:i,viewTransition:a}=n===void 0?{}:n,s=gr(),c=Ar(),h=o0(e,{relative:i});return g.useCallback(m=>{if(zp(m,t)){m.preventDefault();let A=r!==void 0?r:vl(c)===vl(h);s(e,{replace:A,state:l,preventScrollReset:o,relative:i,viewTransition:a})}},[c,s,h,r,l,t,e,o,i,a])}const bp=[{id:"20260508180001",title:"구글 제미나이 2.0, GPT-5 성능 넘어서며 멀티모달 AI 시대 선언",summary:"구글이 차세대 AI 모델 제미나이 2.0을 공개하며 OpenAI GPT-5를 앞선 성능을 입증했다고 발표했습니다. 특히 한국어 처리와 K-콘텐츠 이해 능력이 대폭 향상되어 국내 AI 생태계에 큰 변화가 예상됩니다.",category:"LLM",author:"Prompt Daily 편집팀",date:"2026-05-08T18:00:15+09:00",readTime:"4분",image:"https://images.unsplash.com/photo-1620712943543-bcc4688e7485?w=800",breaking:!0,content:`## 제미나이 2.0의 혁신적 성능 개선
